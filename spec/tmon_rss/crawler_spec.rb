...
describe TmonRss::Crawler do
  ...
  it "should crawl Ticket Monster with one deal" do
    ...
    deal.image.should == "http://img1.tmon.kr/deals/4720/47207337/47207337_catlist_2col_v2_b3f41_1388712985production.jpg"
  ...
  it "should crawl Ticket Monster with two deals" do
    ...
    deal.image.should == "http://img2.tmon.kr/deals/4729/47290385/47290385_catlist_2col_v2_1e1a7_1388737795production.jpg"
